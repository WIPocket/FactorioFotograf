-- settings --
block_size      = 10 -- how long the side of one screenshot should be. This affect if you want 10 100x100 screnshots or 100 10x10 screenshots.
...
script.on_event(defines.events.on_tick, function(event)
	if done == false then -- do only once when game is loaded
		...
		game.print("minx: " .. minx .. " miny: " .. miny .. " maxx: " .. maxx .. " maxy: " .. maxy)
